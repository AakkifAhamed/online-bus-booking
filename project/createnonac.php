...
if(isset($_POST['submit']))
{
	...
	$check="INSERT INTO nonac(vehicleID, Start, Destination,Date,Time,Price,Seats) VALUES ('$AID',' $start','$des','$date','$time','$price','$sav')";
...
<input type="submit" name="submit" id="submit" value="Submit">  <a href="changenonacamount.php">Change Ticket Price</a>
<a href="deletenonacbus.php">Delete Bus</a>
</div>
</form>
</div>
</BODY>
