...
if($result->num_rows>0){
	while($row=$result->fetch_assoc()){
	   ...
	   echo"<td width='90' height='58'>". $row['Destination']."</td>";
	    ...
	    echo"<td>". '<a class="btn btn-danger" href="confirmresetnonac.php?vehicleID=' . $row['vehicleID'] . '" >Reset</a>'."</td>";
		 echo"<td>". '<a class="btn btn-info" href="resetnonacpdf.php?vehicleID=' . $row['vehicleID'] . '" >Save</a>'."</td>";
	   echo "</tr>";
		  }
		  }
	}
