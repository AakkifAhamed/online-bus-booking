...
if(isset($_GET['vehicleID']))
{
	...
	$checkz="DELETE  FROM `acbooking` WHERE vehicleID='".$_GET['vehicleID']."'" ;
...
{
	$query="UPDATE ac SET Destination='".$_POST['destination']."',Date='".$_POST['date']."',Time='".$_POST['time']."' WHERE vehicleID='".$_GET['vehicleID']."'";
