...
if(isset($_POST['Search'])){
	  ...
	  $sql="select * from nonac where Destination='".$_POST['destination']."' ";
...
if($result->num_rows>0){
	while($row=$result->fetch_assoc()){
	  ...
	  echo" <td width='150' height='58'>". $row['Start']."</td>";
       ...
       echo"<td>". '<a class="btn btn-info" href="nonacticket.php?vehicleID=' . $row['vehicleID'] .  '" >View</a>'."</td>";
...
<h2>Details</h2>
<a href="cancelnonactic.php">Cancel Pay</a><br><a href="welcome.php">Back</a>
<form action="nonacbooking.php" method="post">
